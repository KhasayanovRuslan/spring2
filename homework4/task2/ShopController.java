package magazine1.controllers;


import magazine1.entites.Product;
import magazine1.services.GreetingClient;
import magazine1.services.ProductListClient;
...
public class ShopController {
    ...
    @Autowired
    public void setProductListClient(ProductListClient productListClient) { this.productListClient = productListClient; }
    ...
    public String shopPage(Model model,
        ...
        String s = greetingClient.greeting1();
        List<Product> productList = productListClient.getProductList();
